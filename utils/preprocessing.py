def get_preprocessor(
    data_columns, prompter, tokenizer, cutoff_len, train_on_whole_sample: bool = False
):
    def generate_and_tokenize_data(data_sample):
        ...
        full_tokens = tokenizer(full_sample, truncation=True, max_length=cutoff_len - 1, padding=False)
